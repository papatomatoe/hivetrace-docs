...
![Базовые Паттерны](../../../../assets/img/base_dataclean_patterns.webp)
...
![Пользовательские Паттерны](../../../../assets/img/custom_dataclean_patterns.webp)

## Типы обработки данных

Для обнаруженных персональных данных можно задать способ обработки

![Способ обработки](../../../../assets/img/dataclean_masking_types.webp)
...
![Тестирование Очистки Персональных Данных 1](../../../../assets/img/dataclean_test_1.webp)
![Тестирование Очистки Персональных Данных 2](../../../../assets/img/dataclean_test_2.webp)
